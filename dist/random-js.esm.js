...
const browserCrypto = {
    next() {
        if (index$1 >= COUNT$1) {
            if (data$1 === null) {
                data$1 = new I32Array(COUNT$1);
            }
            crypto.getRandomValues(data$1);
            index$1 = 0;
        }
...
export { MersenneTwister19937, Random, bool, browserCrypto, createEntropy, date, dice, die, hex, int32, int53, int53Full, integer, nativeMath, nodeCrypto, pick, picker, real, realZeroToOneExclusive, realZeroToOneInclusive, sample, shuffle, string, uint32, uint53, uint53Full, uuid4 };
